...
\newcommand*{\getTitle}{Fine-grained communication compression for LLMs}
\newcommand*{\getTitleGer}{Titel der Abschlussarbeit}
\newcommand*{\getAuthor}{Jan Hansen-Palmus}
...
\input{chapters/04_sota}
\input{chapters/05_advanced}
\input{chapters/rest}
